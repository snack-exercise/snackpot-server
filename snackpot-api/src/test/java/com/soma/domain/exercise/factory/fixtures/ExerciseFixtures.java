...
public class ExerciseFixtures {
    public static Long 운동id = 1L;
    public static String 영상id = "영상id";
    public static Integer 칼로리 = 5;

    public static Level 난이도 = Level.EASY;

    public static String 효과 = "몸짱이 되요";

    public static String 제목 = "1분 몸짱 되기";
